...
import com.raizlabs.android.dbflow.config.MainGeneratedDatabaseHolder;
import com.raizlabs.android.dbflow.config.ModuleGeneratedDatabaseHolder;
...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        FlowManager.init(new FlowConfig.Builder(this)
                .addDatabaseHolder(MainGeneratedDatabaseHolder.class)
                .addDatabaseHolder(ModuleGeneratedDatabaseHolder.class)
